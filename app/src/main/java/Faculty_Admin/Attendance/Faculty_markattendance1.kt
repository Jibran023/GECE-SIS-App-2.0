...
//                Toast.makeText(this@faculty_markattendance1, "Selected: $selectedCohort", Toast.LENGTH_SHORT).show()

                fetchOfferedCourses()
            }
            override fun onNothingSelected(parent: AdapterView<*>?) {
                // Handle case where no item is selected if needed
                Toast.makeText(this@faculty_markattendance1, "No session selected", Toast.LENGTH_SHORT).show()
            }
        }
...
//                Toast.makeText(this@faculty_markattendance1, "Selected: $selectedCourse", Toast.LENGTH_SHORT).show()
            ...
            override fun onNothingSelected(parent: AdapterView<*>?) {
                // Handle case where no item is selected if needed
                Toast.makeText(this@faculty_markattendance1, "No Course selected", Toast.LENGTH_SHORT).show()
                pass = false
            }
        }
...
//                Toast.makeText(this@faculty_markattendance1, "Selected: $selectedSecionName", Toast.LENGTH_SHORT).show()
        ...
        proceedButton.setOnClickListener {
            if (!pass){
                Toast.makeText(this@faculty_markattendance1, "Please select a valid Cohort/Course/Section", Toast.LENGTH_SHORT).show()
            }
            else {
...
//            val apiGetCohorts = "${LoginScreen.BASE_URL}/geceapi/Faculty_Admin/Faculty/Attendance/fetch_faculty_courses.php?FacultyID=$userID"
            val apiGetCohorts = "${LoginScreen.BASE_URL}/geceapi/fetch_faculty_coursesN.php?FacultyID=$userID"
            ...
            val reqQueue: RequestQueue = Volley.newRequestQueue(this)
            val apiGetCohorts = "${LoginScreen.BASE_URL}/geceapi/fetch_admin_cohortsN.php"
            val jsonArrayRequest = JsonArrayRequest(
                Request.Method.GET,
                apiGetCohorts,
                null,
...
//            val apigetcohorts = "${LoginScreen.BASE_URL}/geceapi/Faculty_Admin/Faculty/Attendance/fetch_faculty_courses2.php?FacultyID=$userID"
            val apigetcohorts = "${LoginScreen.BASE_URL}/geceapi/fetch_faculty_courses2N.php?FacultyID=$userID"
            val jsonArrayRequest = JsonArrayRequest(
                Request.Method.GET,
                apigetcohorts,
                null,
...
//            val apigetcohorts = "${LoginScreen.BASE_URL}/geceapi/Faculty_Admin/Faculty/Attendance/fetch_admin_courses.php?FacultyID=$selectedCohort"
            val apigetcohorts = "${LoginScreen.BASE_URL}/geceapi/fetch_admin_coursesN.php?FacultyID=$selectedCohort"
            val jsonArrayRequest = JsonArrayRequest(
                Request.Method.GET,
                apigetcohorts,
                null,
